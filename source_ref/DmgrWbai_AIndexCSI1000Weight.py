...
class DmgrWbai_AIndexCSI1000Weight(DataManagerMapped):
    def __init__(self):
        DataManagerMapped.__init__(self)
        self.weight = NIO_MATRIX()

        self.rawdata_dir = None # Path("/production/bak/datasvc/rawdata_wind/AIndexCSI1000Weight/")

    def initialize(self, id, path, cfg):
        DataManagerMapped.initialize(self, id, path, cfg)
        self.rawdata_dir = Path(cfg.getAttributeStringDefault('dataPath', '/production/bak/datasvc/rawdata_wind/AIndexCSI1000Weight/'))
        self.addDailyData(self.weight, "AIndexCSI1000Weight.weight")
